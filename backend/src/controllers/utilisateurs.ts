...
const PAGES_DISPONIBLES = [
  ...
  { path: '/suivi-pda',          label: 'Logistique — Suivi PDA',             actions: ['view'] },
  { path: '/expeditions',        label: 'Logistique — Expéditions',           actions: ['view'] },
  { path: '/reparation',        label: 'Production — Réparation',        actions: ['view'] },
  { path: '/maj-injection',    label: 'Production — MAJ / Injection',   actions: ['view'] },
  { path: '/controle-qualite', label: 'Production — Contrôle qualité',  actions: ['view'] },
  { path: '/attente-info',     label: 'Production — Attente info',       actions: ['view'] },
  { path: '/planning',         label: 'Production — Planning',           actions: ['view'] },
  { path: '/suivi',                     label: 'Production — Suivi',              actions: ['view'] },
  { path: '/suivi-pda-labo',            label: 'Production — Suivi PDA Labo',     actions: ['view'] },
