...
export default function ChangerMdpModal({ onSuccess }: Props) {
  ...
  return (
    <div className="modal-overlay">
      <div style={{ background: 'white', borderRadius: '10px', padding: '32px', maxWidth: '480px', width: '100%' }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* Règles de sécurité */}
          <div style={{ background: '#f8fafc', border: '1px solid #e5e7eb', borderRadius: '8px', padding: '12px 16px', marginBottom: '16px' }}>
